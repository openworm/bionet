COMMENT
   ...
   **************************************************
   ...
   Acetylcholine (Type: Synaptic mechanism, Model: Template based ChannelML file)

   with parameters: 
   /channelml/@units = Physiological Units 
   /channelml/notes = ChannelML file describing a single synaptic mechanism 
   /channelml/synapse_type/@name = Acetylcholine 
...
// File from which this was generated: C:\Users\Tom\Documents\research\OpenWorm\CElegansNeuroConstruct\CElegansNeuroML\CElegans\cellMechanisms\Acetylcholine\DoubExpSyn.xml

// XSL file with mapping to simulator: C:\Users\Tom\Documents\research\OpenWorm\CElegansNeuroConstruct\CElegansNeuroML\CElegans\cellMechanisms\Acetylcholine\ChannelML_v1.8.1_NEURONmod.xsl
